...
<center><h>SEWA Sign-in</h></center>

<center><button onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><h1>Log In</h1></button></center>
<center><button onclick="document.getElementById('id02').style.display='block'" style="width:auto;"><h1>New Customer</h1></button></center>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="includes/signup.inc.php" method="post">
    ...
    <label for="Last Name"><b>Last Name</b></label>
      ...
      <label for="Address"><b>OPTIONAL Email Address</b></label>
